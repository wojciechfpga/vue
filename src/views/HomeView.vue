...
const getArticles = (kindOfArticle, token) => post('https://wojciechlasowskiapi.azurewebsites.net/getarticles', kindOfArticle, token);
...
const deleteArticle = (kindOfArticle, token) => postDelete('https://wojciechlasowskiapi.azurewebsites.net/deletearticle', kindOfArticle, token);
export default {
  name: 'Home',
  components: {
    UsersMessages,
